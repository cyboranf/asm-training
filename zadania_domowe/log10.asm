...
;        st = [st0] = [log10(2)]  ; fpu stack

         fld qword [eax]  ; *(double*)eax = *(double*)addr_y = 1.0 -> st  ; fpu load floating-point

;        st = [st0, st1] = [1.0, log10(2)]  ; fpu stack

         fld qword [eax+8]  ; *(double*)(eax+8) = *(double*)addr_x = x -> st  ; fpu load floating-point

;        st = [st0, st1, st2] = [x, 1.0, log10(2)]  ; fpu stack

;        fyl2x  ; st(1) := st(1)*log2[st(0)] i zdejmij

         fyl2x  ; [st0, st1, st2] => [st0, st1*log2(st(0)), st2] => [st1*log2(st(0)), st2] = [log2(x), st2]

;        st = [st0, st1] = [log2(x), log10(2)]

;        fmulp stn  ; stn = stn * st0 i zdejmij
         fmulp st1  ; [st0, st1] => [st0, st1*st0] => [st1*st0] = [log10(x)]
